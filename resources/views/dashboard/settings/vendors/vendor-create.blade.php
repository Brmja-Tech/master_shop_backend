<x-create-modal title="{{ __('dashboard.create-vendor') }}">
    <div class="row mt-2">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-1">
            ...
            <input type="password" wire:model="password" class="form-control" placeholder="{{ __('dashboard.password') }}">
    ...
    <div class="row">
        <div class="col-md-6 mb-1">
            <div class="form-check form-switch mt-2">
                <input type="checkbox" wire:model="is_verified" class="form-check-input" id="is_verified_create">
                <label class="form-check-label" for="is_verified_create">{{ __('dashboard.verified') }}</label>
            </div>
