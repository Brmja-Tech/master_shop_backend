                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6 mb-1 mb-md-0">
                                <h6 class="text-muted border-bottom pb-50 mb-1 fw-bold">{{ __('dashboard.vendor_details') }}</h6>
                                <div class="d-flex align-items-center mb-1">
                                    <div class="avatar bg-light-primary p-50 me-1 rounded" style="width: 38px; height: 38px; display: flex; align-items: center; justify-content: center;">
                                        <span class="avatar-content fw-bold text-uppercase">{{ mb_substr($selectedRequest->vendor?->store_name ?? $selectedRequest->vendor?->owner_name ?? 'T', 0, 2) }}</span>
                                    </div>
                                    <div>
                                        <h5 class="mb-25 fw-bolder">{{ $selectedRequest->vendor?->store_name ?? $selectedRequest->vendor?->owner_name }}</h5>
                                        <span class="text-muted fs-6">{{ $selectedRequest->vendor?->email }}</span>
                                    </div>
                                </div>
                                <table class="table table-borderless table-sm">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="py-25 text-start">{{ $selectedRequest->vendor?->phone }}</td>
                                        </tr>
                                        <tr>
