...
return [
    ...
    'callback_url' => env('PAYMOB_CALLBACK_URL', 'https://mastershop.brmja.cloud/api/paymob/callback'),
    'response_url' => env('PAYMOB_RESPONSE_URL', 'https://mastershop.brmja.cloud/api/paymob/response'),
