...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('delivery_withdrawal_requests')) {
            return;
        }

        Schema::create('delivery_withdrawal_requests', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('delivery_withdrawal_requests');
    }
};
